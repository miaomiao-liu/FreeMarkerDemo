...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet" xmlns:o="urn:schemas-microsoft-com:office:office"
    ...
    <DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
        ...
        <Created>2018-02-28T17:52:23Z</Created>
        <LastSaved>2018-02-28T17:58:15Z</LastSaved>
    </DocumentProperties>
    <CustomDocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
        <KSOProductBuildVer dt:dt="string">2052-10.1.0.7106</KSOProductBuildVer>
    ...
    <Worksheet ss:Name="Sheet1">
        <Table ss:ExpandedColumnCount="100" ss:ExpandedRowCount="100" x:FullColumns="1" x:FullRows="1"
            ...
            <Row>
                ...
                <Cell>
                    <Data ss:Type="Number">${student.grade}</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="Number">${student.cls}</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="Number">${student.english}</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="Number">${student.chinese}</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="Number">${student.math}</Data>
                </Cell>
            </Row>
            </#list>
        </Table>
